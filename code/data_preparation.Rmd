...
read.csv(paste0(wd,"/data/original/",batch,"/samples_",batch,".csv")) %>%
  #select relevant columns
  select(
    #Sample columns
    Code,Type,Freshness,Freezing,
    #Host specimen columns
    Specimen.ID,Species,Order,Class..from.Specimen.ID...from.Captures.ID.,Development,Sex,Length..mm.,Weight..g.,
    #Capture columns
  ...
  filter(specimen_id != "") %>%
  #save clean table
  write.csv(paste0(wd,"/data/samples.csv"))
```
...
read.csv(paste0(wd,"/data/original/",batch,"/extraction_",batch,".csv")) %>%
  ...
  #save clean table
  write.csv(paste0(wd,"/data/extraction.csv"))
```
...
read.csv(paste0(wd,"/../data/original/",batch,"/library_",batch,".csv")) %>%
  ...
  #save clean table
  write.csv(paste0(wd,"/../data/library.csv"))
```
...
read.csv(paste0(wd,"/data/original/",batch,"/index_",batch,".csv")) %>%
  ...
  #save clean table
  write.csv(paste0(wd,"/data/index.csv"))
```
...
read.csv(paste0(wd,"/data/original/",batch,"/sequence_",batch,".csv")) %>%
  ...
  #save clean table
  write.csv(paste0(wd,"/data/sequence.csv"))
```
...
read.csv(paste0(wd,"/data/original/",batch,"/preprocessing_",batch,".csv")) %>%
  ...
  #save clean table
  write.csv(paste0(wd,"/data/preprocessing.csv"))
```
...
read.csv(paste0(wd,"/data/original/",batch,"/assembly_",batch,".csv")) %>%
  ...
  #save clean table
  write.csv(paste0(wd,"/data/assembly.csv"))
```
...
read.csv(paste0(wd,"/data/original/",batch,"/mags_",batch,".csv")) %>%
  ...
  #save clean table
  write.csv(paste0(wd,"/data/mags.csv"))
```
...
combined <- ppr %>%
  ...
  inner_join(., sam, by = c("sample_id.x" = "sample_id")) %>%

  write.csv(paste0(wd, "/../data/combined.csv"))
```
